...
<script type="text/javascript" src="/kosta111MidProject/javascriptFiles/uml/inspector.js"></script>
		...
		<div class="inspector-container">
			<div class="inspector">
				...
				<!-- <div class="create">
					<div>
						<label>Class</label>
						<button class="btn-class-add">+</button>
					</div>
					<div>
						<label>Interface</label>
						<button class="btn-interface-add">+</button>					
					</div>
					<div>
						<label>Abstract</label>
						<button class="btn-abstract-add">+</button>					
					</div>				
				</div> -->
			</div><!-- end inspector -->
